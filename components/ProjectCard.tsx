  ...
  const hasDetails = project._desc || (project._highlights && project._highlights.length > 0);
    ...
    return (
      <motion.div
        ...
        transition={{ duration: 0.5, delay: project.order * 0.05 }}
      >
        <div className="relative aspect-video w-full overflow-hidden">
          {project.thumbnail ? (
            ...
            <div className="flex h-full w-full items-center justify-center bg-white/5">
              <HiCodeBracket className="h-12 w-12 text-[var(--accent-color)] opacity-50" />
            </div>
          )}
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              {project.featured && (
                <div className="flex-shrink-0">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-[var(--accent-color)]/10 px-3 py-1 text-xs font-medium text-[var(--accent-color)]">
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm text-white/60">
                {project.client && (
                  <div className="flex items-center gap-2">
                    <HiBuildingOffice2 className="h-4 w-4 text-[var(--accent-color)]" />
                    <span>
                ...
                {(project.startDate || project.endDate) && (
                  <div className="flex items-center gap-2">
                    <HiCalendarDays className="h-4 w-4 text-[var(--accent-color)]" />
                    <span>
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                {project.metrics.map((metric, i) => (
                  <div key={i} className="rounded-lg bg-white/5 p-3 text-center">
                    <p className="text-xl font-bold text-[var(--accent-color)]">{metric.value}</p>
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row">
            {project.demoUrl && (
              <a
                ...
                className="group inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-[var(--accent-color)] px-5 py-3 text-sm font-semibold text-black transition-transform hover:scale-[1.03]"
              >
