...
export default function Home() {
  ...
  const nodes = [
    ...
    },
    {
      ...
      content: <EducationSection language={selectedLanguage ?? 'EN'} />,
    },
    {
      id: 'experience',
      label: 'EXPERIENCE',
      ...
      content: <ExperienceSection language={selectedLanguage ?? 'EN'} />,
    },
    {
      id: 'projects',
      label: 'PROJETOS',
      ...
      content: <ProjectsSection language={selectedLanguage ?? 'EN'} />,
    },
    {
      id: 'skills',
      label: 'SKILLS',
      ...
      content: <SkillsSection language={selectedLanguage ?? 'EN'} />,
    },
    {
      id: 'personal',
      label: 'PESSOAL',
